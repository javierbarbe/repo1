...
public class InteresBancario {
	...
	public static void main (String[] args) {
		...
		pagoMensual = (( cantidadPrestamo * tasaInteres ) / (1 - 1 / (Math.pow((1  + tasaDeInteres ),( añosPago*12 )))));
		cantidadPago = pagoMensual * añosPago * 12;
		...
		System.out.printf("El pago mensual es de %f%nEl pago total es de %f%n", pagoMensual,cantidadPago);
